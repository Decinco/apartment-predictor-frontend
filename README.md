...
![List without apartments](docs/images/list_empty.png)
![List with apartments](docs/images/list_full.png)
...
![Viewing an apartment](docs/images/view.png)
...
![Prompt when deleting apartment](docs/images/view_delete.png)
...
![Apartment creation](docs/images/edit_create.png)
...
![Apartment edition](docs/images/edit_existing.png)
...
![Apartment list in light mode](docs/images/list_bright.png)

## Responsiveness

This application's UI is responsive to small and medium screens. Here are some screenshots of what the UI looks like:

![List with apartments in a small screen](docs/images/list_mobile.png)
![Viewing an apartment in a small screen](docs/images/view_mobile.png)
![Apartment edition in a small screen](docs/images/edit_mobile.png)
