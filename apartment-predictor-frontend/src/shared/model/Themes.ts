...
export const Themes: ApartmentApplicationTheme[] = [
  {
    ...
    vars: {
      ...
      "--accent-hover-destructive-start":   cssVar("--color-red-600"),
  ...
  },
  {
    ...
    vars: {
      ...
      "--accent-hover-destructive-start":   cssVar("--color-red-500"),
      "--accent-hover-destructive-end":     cssVar("--color-red-500"),
      "--border-destructive":               cssVar("--color-red-500"),
      "--field-border":                     cssVar("--color-yellow-400"),
      "--field-bg":                         cssVar("--color-yellow-50"),
      "--checkmark":                        cssVar("--color-yellow-400"),
    }
  }
]